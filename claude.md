...
> | ドキュメント | パス | 参照すべき場面 |
> |-------------|------|---------------|
> | **企画書** | `docs/SalonTalk-AI-企画書-v1_0.md` | ビジネス要件、市場分析、財務計画、競合分析 |
> | **要件定義書** | `docs/SalonTalk-AI-要件定義書-v1_0.md` | 機能要件(FR-xxx)、非機能要件、受け入れ基準、ユースケース |
> | **基本設計書** | `docs/SalonTalk-AI-基本設計書-v1_0.md` | システムアーキテクチャ、画面設計、API設計、データ設計 |
> | **詳細設計書** | `docs/SalonTalk-AI-詳細設計書-v1_0.md` | クラス設計、シーケンス図、アルゴリズム、DB物理設計、テスト仕様 |
> 
> **これらのドキュメントはプロジェクトルートの `docs/` フォルダに配置されています。**
...
│   ├── SalonTalk-AI-企画書-v1_0.md           # ビジネス要件・財務計画
│   ├── SalonTalk-AI-要件定義書-v1_0.md       # 機能要件・非機能要件
│   ├── SalonTalk-AI-基本設計書-v1_0.md       # アーキテクチャ・画面設計
│   └── SalonTalk-AI-詳細設計書-v1_0.md       # クラス設計・アルゴリズム
│
├── .github/
│   └── workflows/                  # CI/CD
│
...
| ドキュメント | ファイル | 主な内容 |
|-------------|---------|---------|
| 企画書 | `docs/SalonTalk-AI-企画書-v1_0.md` | ビジネス目標、市場分析、ROI計算、競合比較 |
| 要件定義書 | `docs/SalonTalk-AI-要件定義書-v1_0.md` | 機能要件一覧(FR-101〜)、非機能要件、受け入れ基準 |
| 基本設計書 | `docs/SalonTalk-AI-基本設計書-v1_0.md` | システム構成、画面遷移、API仕様、ER図 |
| 詳細設計書 | `docs/SalonTalk-AI-詳細設計書-v1_0.md` | TypeScriptクラス設計、シーケンス図、Claudeプロンプト、テスト仕様 |
