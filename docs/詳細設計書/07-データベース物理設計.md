...
CREATE TABLE device_activations (
  ...
  activation_code VARCHAR(6) NOT NULL,            -- 6桁アクティベーションコード
  ...
  CONSTRAINT device_activations_code_unique UNIQUE (activation_code),
...
| device_activations | idx_device_activations_code | activation_code | B-tree (部分) | 🆕 未使用コード検索 |
